...
public class BeanAdapter extends NamedElementAdapter {
	...
	BeanAdapter(Bean facade, org.eclipse.uml2.uml.Class beanClass,
			org.eclipse.emf.compare.uml2.facade.tests.j2eeprofile.Bean stereotype) {
	...
	@Override
	public org.eclipse.emf.compare.uml2.facade.tests.j2eeprofile.Bean getStereotype() {
		return (org.eclipse.emf.compare.uml2.facade.tests.j2eeprofile.Bean)super.getStereotype();
	}
	...
	static BeanAdapter connect(Bean facade, org.eclipse.uml2.uml.Class beanClass) {
		...
		org.eclipse.emf.compare.uml2.facade.tests.j2eeprofile.Bean stereotype = UMLUtil
				.getStereotypeApplication(beanClass,
						org.eclipse.emf.compare.uml2.facade.tests.j2eeprofile.Bean.class);
	...
	static boolean isBeanClass(Object object) {
		return (object instanceof org.eclipse.uml2.uml.Class)
				&& (UMLUtil.getStereotypeApplication((org.eclipse.uml2.uml.Class)object,
						org.eclipse.emf.compare.uml2.facade.tests.j2eeprofile.Bean.class) != null);
	...
	public void syncKindToModel(Bean facade,
			org.eclipse.emf.compare.uml2.facade.tests.j2eeprofile.Bean model) {

		if (!Objects.equals(facade.getKind().getLiteral(), model.getKind().getLiteral())) {
			model.setKind(org.eclipse.emf.compare.uml2.facade.tests.j2eeprofile.BeanKind
	 ...
	 *            the façade
	 */
	public void syncKindToFacade(org.eclipse.emf.compare.uml2.facade.tests.j2eeprofile.Bean model,
			Bean facade) {
