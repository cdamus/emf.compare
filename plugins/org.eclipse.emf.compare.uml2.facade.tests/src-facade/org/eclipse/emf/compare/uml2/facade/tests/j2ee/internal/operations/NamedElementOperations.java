 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.emf.compare.uml2.facade.tests.j2ee.NamedElement#getQualifiedName() <em>Get Qualified
 * Name</em>}</li>
 * <li>{@link org.eclipse.emf.compare.uml2.facade.tests.j2ee.NamedElement#getPackage() <em>Get
 * Package</em>}</li>
 * <li>{@link org.eclipse.emf.compare.uml2.facade.tests.j2ee.NamedElement#setPackage(org.eclipse.emf.compare.uml2.facade.tests.j2ee.Package)
...
public class NamedElementOperations {
	...
	protected static void computeQualifiedName(NamedElement namedElement, StringBuilder result) {
		org.eclipse.emf.compare.uml2.facade.tests.j2ee.Package package_ = namedElement.getPackage();
		if (package_ != null) {
