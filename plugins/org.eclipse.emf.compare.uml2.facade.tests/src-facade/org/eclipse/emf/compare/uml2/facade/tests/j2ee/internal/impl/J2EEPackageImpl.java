...
public class J2EEPackageImpl extends EPackageImpl implements J2EEPackage {
	 ...
	 * @see org.eclipse.emf.compare.uml2.facade.tests.j2ee.J2EEPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(packageEClass, org.eclipse.emf.compare.uml2.facade.tests.j2ee.Package.class, "Package", //$NON-NLS-1$
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPackage_Member(), this.getNamedElement(), this.getNamedElement_Package(), "member", //$NON-NLS-1$
				null, 0, -1, org.eclipse.emf.compare.uml2.facade.tests.j2ee.Package.class, IS_TRANSIENT,
				IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				IS_DERIVED, !IS_ORDERED);
		initEReference(getPackage_Bean(), this.getBean(), null, "bean", null, 0, -1, //$NON-NLS-1$
				org.eclipse.emf.compare.uml2.facade.tests.j2ee.Package.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
		initEReference(getPackage_HomeInterface(), this.getHomeInterface(), null, "homeInterface", null, 0, //$NON-NLS-1$
				-1, org.eclipse.emf.compare.uml2.facade.tests.j2ee.Package.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				!IS_ORDERED);
