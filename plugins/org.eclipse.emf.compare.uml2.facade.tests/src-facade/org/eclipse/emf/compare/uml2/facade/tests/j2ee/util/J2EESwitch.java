 ...
 * @generated
 */
public class J2EESwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case J2EEPackage.PACKAGE: {
				org.eclipse.emf.compare.uml2.facade.tests.j2ee.Package package_ = (org.eclipse.emf.compare.uml2.facade.tests.j2ee.Package)theEObject;
			...
			case J2EEPackage.NAMED_ELEMENT: {
			...
			case J2EEPackage.HOME_INTERFACE: {
				HomeInterface homeInterface = (HomeInterface)theEObject;
				T result = caseHomeInterface(homeInterface);
				if (result == null)
					result = caseNamedElement(homeInterface);
				if (result == null)
					result = defaultCase(theEObject);
				return result;
			}
			case J2EEPackage.FINDER: {
				...
				if (result == null)
					result = caseNamedElement(finder);
				if (result == null)
					result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T casePackage(org.eclipse.emf.compare.uml2.facade.tests.j2ee.Package object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Home Interface</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Home Interface</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHomeInterface(HomeInterface object) {
		return null;
	}
