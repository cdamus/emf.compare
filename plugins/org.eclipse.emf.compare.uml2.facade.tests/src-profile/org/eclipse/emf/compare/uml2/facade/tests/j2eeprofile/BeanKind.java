 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.emf.compare.uml2.facade.tests.j2eeprofile.J2EEProfilePackage#getBeanKind()
 * @model
 * @generated
 */
public enum BeanKind implements Enumerator {
	 ...
	 * @generated
	 */
	private static final BeanKind[] VALUES_ARRAY =
		new BeanKind[] {
			SESSION,
			ENTITY,
			MESSAGEDRIVEN,
	...
	public static BeanKind get(int value) {
		switch (value) {
			...
			case MESSAGEDRIVEN_VALUE: return MESSAGEDRIVEN;
		}
		return null;
	}
