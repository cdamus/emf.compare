...
/**
 * Control test case for conflict resolution in a three-way comparison using just the raw UML (controls
 * corresponding to the test cases in the {@link BasicConflictMergeWithFacadeTest} class).
 *
 * @author Christian W. Damus
 */
@SuppressWarnings({"nls", "boxing", "restriction" })
@RunWith(RuntimeTestRunner.class)
@DisabledFacadeProviders(J2EEFacadeProvider.Factory.class)
public class BasicConflictMergeJustUMLControlTest {
	...
	/**
	 * The control test for {@link BasicConflictMergeWithFacadeTest#mergeHomeInterfaceConflict(Comparison)}.
	 */
	...
	public void mergeHomeInterfaceConflict(final Comparison comparison) {
		...
		// The UML world doesn't understand any conflict here
		assertThat(conflicts, emptyIterable());
